defmodule GroceryAid.Release do
  @moduledoc """
  Release-time tasks invoked from `bin/grocery_aid eval ...` inside the
  ...
  @doc """
  Runs the (idempotent) starter seeds. Safe to call on every boot.
  """
  def seed do
    load_app()
