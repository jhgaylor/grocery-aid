defmodule GroceryAidWeb.Layouts do
  @moduledoc """
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8 border-b border-base-300">
      <div class="flex-1">
        <a href={~p"/"} class="flex w-fit items-center gap-2">
          <.icon name="hero-shopping-cart" class="size-6 text-primary" />
          <span class="text-base font-bold tracking-tight">Grocery Aid</span>
        </a>
      </div>
      <div class="flex-none">
        <ul class="flex flex-column px-1 space-x-1 items-center">
          <li><.link navigate={~p"/meals"} class="btn btn-ghost btn-sm">Meals</.link></li>
          <li>
          ...
          <li>
            <.link navigate={~p"/shopping-list"} class="btn btn-primary btn-sm">
              <.icon name="hero-list-bullet" class="size-4" /> Shopping List
            </.link>
          </li>
          <li><.theme_toggle /></li>
        </ul>
